...
gchar *
mdu_util_get_size_for_display (guint64 size,
                               gboolean use_pow2,
...
char *
mdu_util_get_fstype_for_display (const char *fstype, const char *fsversion, gboolean long_string)
{
        char *s;
...
char *
mdu_get_job_description (const char *job_id)
{
        char *s;
...
void
mdu_util_part_type_foreach (MduUtilPartTypeForeachFunc callback, gpointer user_data)
{
        int n;
...
char *
mdu_util_get_desc_for_part_type (const char *scheme, const char *type)
{
        int n;
...
char *
mdu_util_fstype_get_description (char *fstype)
{
...
char *
mdu_util_part_table_type_get_description (char *part_type)
{
...
char *
mdu_util_get_default_part_type_for_scheme_and_fstype (const char *scheme, const char *fstype, guint64 size)
{
        const char *type;
...
gchar *
mdu_util_get_secret (MduDevice *device)
{
        const char *usage;
        const char *uuid;
        char *password;
...
gboolean
mdu_util_have_secret (MduDevice *device)
{
        const char *usage;
        const char *uuid;
        char *password;
...
gboolean
mdu_util_delete_secret (MduDevice *device)
{
        const char *usage;
        const char *uuid;
        gboolean ret;
...
char *
mdu_util_get_speed_for_display (guint64 speed)
{
        char *str;
...
char *
mdu_util_get_connection_for_display (const char *connection_interface, guint64 connection_speed)
{
        const char *name;
        char *result;
        ...
        if (connection_speed > 0) {
                ...
                speed = mdu_util_get_speed_for_display (connection_speed);
...
gchar *
mdu_linux_md_get_raid_level_for_display (const gchar *linux_md_raid_level,
                                         gboolean long_string)
{
        gchar *ret;
...
char *
mdu_linux_md_get_raid_level_description (const gchar *linux_md_raid_level)
{
        gchar *ret;
...
/**
 * mdu_util_ata_smart_status_to_desc:
 ...
 */
gchar *
mdu_util_ata_smart_status_to_desc (const gchar  *status,
                                   ...
                                   GIcon       **out_icon)
{
        ...
        if (g_strcmp0 (status, "GOOD") == 0) {
                ...
                icon = g_themed_icon_new ("mdu-smart-healthy");
                ...
                highlight = TRUE;
                icon = g_themed_icon_new ("mdu-smart-threshold");
                ...
                action_text = _("Backup all data and replace the disk");
                highlight = TRUE;
                icon = g_themed_icon_new ("mdu-smart-failing");
...
GIcon *
mdu_util_get_emblemed_icon (const gchar *name,
